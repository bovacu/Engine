 ...
 *  system or its drivers, or a lack of required assets.  Report the issue to
 ...
 *  should be terminated in order to free any assets allocated during or
 ...
 *  modified gamma ramps and frees any other allocated assets.  Once this
 ...
 *  windowed mode.
 *  @param[in] share The window whose context to share assets with, or `NULL`
 *  to not share assets.
 ...
 *
 *  @remark @win32 The context to share assets with must not be current on
 *  any other thread.
 *
